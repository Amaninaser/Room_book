...
<body>
  ...
  <!-- END: header -->
	<!-- <div id="booking" class="section" style="background-image: url({{ asset('images/background.jpg')}});">
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-12">
          ...
          <div class="probootstrap-cta-button-wrap"><a href="/admin/reservations" class="btn btn-primary">Reserve now</a></div>
        </div>
      </div>
    </div>
  </section>
      ...
      <div class="row probootstrap-gutter10">
        <div class="col-md-6">
          <div class="probootstrap-block-image-text">
            <figure>
              <a href="{{ asset('images/img_1.jpg') }}" class="image-popup">
                <img src="{{ asset('images/img_1.jpg') }}" alt="Free HTML5 Bootstrap Template by uicookies.com" class="img-responsive">
              </a>
              <div class="actions">
        ...
        <div class="col-md-6">
          <div class="probootstrap-block-image-text">
            <figure>
              <a href="{{ asset('images/img_2.jpg') }}" class="image-popup">
                <img src="{{ asset('images/img_2.jpg') }}" alt="Free HTML5 Bootstrap Template by uicookies.com" class="img-responsive">
              </a>
              <div class="actions">
                <a href="https://vimeo.com/45830194" class="popup-vimeo"><i class="icon-play2"></i></a>
              </div>
