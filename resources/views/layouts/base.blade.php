        ...
        <div class="row">
          <div class="col-md-12 probootstrap-relative">
            ...
            <ul class="probootstrap-owl-navigation absolute right">
              <li><a href="#" class="probootstrap-owl-prev"><i class="icon-chevron-thin-left"></i></a>
            </li>
              <li><a href="#" class="probootstrap-owl-next"><i class="icon-chevron-thin-right"></i></a>
            </li>
            </ul>
          </div>
        </div>
          ...
          <div class="col-md-12 probootstrap-relative">
            ...
            <div class="item">
                <div class="probootstrap-room">
                  <a href="#"><img src="{{ $room->image }}" alt="{{ $room->room_name}}" class="img-responsive"></a>
                  <div class="text">
                    <h3>{{ $room->room_name}}</h3>
                    <p>Starting from <strong>${{room->current_price}}/Night</strong></p>
                    <div class="post-meta">
                      <ul>
                        <li><span class="review-rate">4.7</span> <i class="icon-star"></i> {{$room->reviwes}} Reviews</li>
                        <li><i class="icon-user2"></i> {{$room->stars}} Guests</li>
                      </ul>
                    </div>
                  </div>
                </div>
