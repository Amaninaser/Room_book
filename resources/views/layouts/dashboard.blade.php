    ...
    <aside>
      <div id="sidebar" class="nav-collapse ">
        ...
        <ul class="sidebar-menu" id="nav-accordion">
          ...
          <li class="mt">
            <a class="active" href="/admin/rooms/create">
          ...
          <li class="sub-menu">
            ...
            <ul class="sub">
              <li><a href="grids.html">Show Reservation</a></li>
              <li><a href="calendar.html">Confirm Reservation</a></li>
              <li><a href="todo_list.html">Delete Reservation</a></li>
            </ul>
          </li>
          <li class="sub-menu">
            <a href="javascript:;">
          ...
          <li class="sub-menu">
            <a href="javascript:;">
              <i class="fa fa-cities"></i>
              <span>City</span>
              </a>
            <ul class="sub">
            <li><a href="contactform.html">Show City</a></li>
              <li><a href="form_component.html">Add City</a></li>
              <li><a href="advanced_form_components.html">Update City</a></li>
              <li><a href="form_validation.html">Delete City</a></li>
            </ul>
          </li>
