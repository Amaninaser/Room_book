    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-4 col-sm-6 col-xs-12">
          <div class="probootstrap-room">
            <a href="#"><img src="{{ asset('img/g_1.jpg') }}" alt="{{$room->room_name}}" class="img-responsive"></a>
            <div class="text">
              <h3>{{$room->room_name}}</h3>
              <p>Starting from <strong>${{$room->current_price}}/Night</strong></p>
              <div class="post-meta mb30">
                <ul>
                  <li><span class="review-rate">{{$room->reviwes}}</span> <i class="icon-star"></i> 252 Reviews</li>
                  <li><i class="icon-user2"></i> {{$room->max_guest}} Guests</li>
                </ul>
              </div>
              <p><a href="#" class="btn btn-primary" role="button">More Details</a></p>
              <p><a href="#" class="btn btn-primary" role="button">Reserve now for ${{$room->current_price}}</a></p>
      ...
      <div class="row">
        <div class="col-md-12 text-center">
          <h2>Why Choose Us?</h2>
          <p class="mb50"><img src="{{ asset('img/curve.svg') }}" class="svg" alt="Free HTML5 Bootstrap Template"></p>
        </div>
        <div class="col-md-4">
        ...
        <div class="col-md-4">
          <div class="probootstrap-footer-widget">
            ...
            <ul class="probootstrap-blog-list">
              <li>
                <a href="#">
                  <figure class="probootstrap-image"><img src="{{ asset('img/img_1.jpg') }}" alt="Free Bootstrap Template by uicookies.com" class="img-responsive"></figure>
              ...
              <li>
                <a href="#">
                  <figure class="probootstrap-image"><img src="{{ asset('img/img_2.jpg') }}" alt="Free Bootstrap Template by uicookies.com" class="img-responsive"></figure>
                  <div class="probootstrap-text">
                    <h4>River named Duden flows</h4>
                    <span class="meta">August 2, 2017</span>
                    <p>A small river named Duden flows by their place</p>
              ...
              <li>
                <a href="#">
                  <figure class="probootstrap-image"><img src="{{ asset('img/img_3.jpg') }}" alt="Free Bootstrap Template by uicookies.com" class="img-responsive"></figure>
                  <div class="probootstrap-text">
                    <h4>River named Duden flows</h4>
                    <span class="meta">August 2, 2017</span>
                    <p>A small river named Duden flows by their place</p>
